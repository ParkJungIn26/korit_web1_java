...
public class MapMain {
    public static void main(String[] args) {
        ...
        // Map에서는 key 중복 불가능 - 중복이 안 되게 하는 방법이 해쉬함수
        ...
        // 같은 객체면 key로 사용할 때 중복 제거의 대상이 된다.
        ...
        // Set 안에 Map 가능? ㅇ
        // 중복 제거 -> Map 클래스의 hashCode(), equals()가 사용됨
        // key가 기준이 되어서 중복이 제거됨
        ...
        // 두 가지 방법 모두 성능이 비슷함
        // 방법 1) keySet() + .get() -> 매 반복마다 해시 탐색
        // 방법 2) entrySet() -> 해시 탐색 1회로 키+값 모두 접근
        // 수만개 데이터 기준으로는 20~30% 차이 남
        // 방법 2 권장함
