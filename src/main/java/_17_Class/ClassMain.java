...
public class ClassMain {
    public static <Stirng> void main(String[] args) {
        ...
        // student2가 담은 객체의 주소는 30번재 라인에서 생성되었다.
        ...
        // student1과 student2는 Student 클래스로 만들어진 객체다 (o)
        ...
        1. main에서 Car 객체를 생성
        2. 객체의 필드에 접근해서 현대, 소나타, 2023을 초기화
